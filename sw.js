...
const CACHE_NAME = "treino-pro-v1.2.0";
const STATIC_ASSETS = [
  "/",
  "/index.html",
  "/login.html",
  ...
  "/js/pages/professor.js",
  "/js/pages/aluno.js",
  "/js/services/plano-generator.js",
  "/js/pages/montar-treino.js",
  "/js/features/treinos.js",
  "/js/features/dietas.js",
  "/js/features/imc.js",
  "/js/features/mensagens.js",
  "/manifest.json",
...
self.addEventListener("activate", (event) => {
  console.log("[SW] Ativando Service Worker v1.2.0...");
  event.waitUntil(
  ...
  // Garante que o novo SW assuma o controle imediatamente
  self.clients.claim();
});
